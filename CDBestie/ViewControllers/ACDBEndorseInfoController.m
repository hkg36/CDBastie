...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 1) {
        {
            NSArray *cs=[userInfo.endors_list[indexPath.row] valueForKey:@"merchandise"];
            DZWebBrowser *webBrowser = [[DZWebBrowser alloc] initWebBrowserWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",[cs valueForKey:@"show_post_url"],[[NSUserDefaults standardUserDefaults] objectForKey:@"SESSION_ID"]]]];
